...
elseif ($mod == 'nilai_tambah') {
    ...
    if (!$id_atribut || !$nama_nilai)
        ...
        $db->query("INSERT INTO tb_nilai (id_atribut, nama_nilai,bobot) VALUES ('$id_atribut', '$nama_nilai', '$bobot')");
    ...
    if (!$id_atribut || !$nama_nilai)
        ...
        $db->query("UPDATE tb_nilai SET id_atribut='$id_atribut', nama_nilai='$nama_nilai',bobot='$bobot' WHERE id_nilai='$_GET[ID]'");
        redirect_js("index.php?m=nilai");
    }
...
if ($mod == 'atribut_tambah') {
    ...
    $db->query("DELETE FROM tb_barang WHERE id_barang='$_GET[ID]'");
    header("location:index.php?m=barang");
} 

else if ($mod == 'barang_ubah') {
    $kode = $_POST['kode'];
    $nama = $_POST['nama'];
    $jenis = $_POST['jenis'];
    ...
    if (!$kode )
        ...
        $db->query("UPDATE tb_barang SET nama_barang='$nama', jenis_barang='$jenis', panjang='$panjang', lebar='$lebar', tinggi='$tinggi', volume='$volume', harga_barang='$harga', harga_meter='$harga_meter', stok='$stok' WHERE id_barang='$_GET[ID]'");
        redirect_js("index.php?m=barang");
    }
}
// else if($mod=='barang_ubah'){
//     $data = array();
...
//         $data['error_string'][] = 'Name is Null';
//         $data['status'] = FALSE;
//     }
...
//         exit();
//     }else{
//         $db->query("UPDATE tb_barang SET nama_barang='$nama',jenis='$jenis',stok='$stok',panjang='$panjang',lebar='$lebar',tinggi='$tinggi',volume='$volume',harga='$harga',harga_meter='$harga_meter'  WHERE id_barang='$_GET[ID]'"); 
